						...
						<div class="gray-container single-page-t"><?php 
							...
							if(apply_filters ('the_title', get_the_title()) !=''  ) {
								if($post_showtitle != 'hide'){?>                         	
									<h1 class="content-title" style="padding-top:15px;"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1> <?php 
								};
							};
							the_content();  
							if($post_showcategory != "hide"){ ?>
								<div class="icon-soc-container">
									<div class="share-btns">
										...
										<div class="navigation empty-right">	
			<?php previous_post_link('<strong>?</strong> %link') ?> | <?php next_post_link(' %link <strong>?</strong>')?>
									</div>
								</div>   
							</div><?php
							};?>
